...
import infoImage from "../../../public/images/softSkill.webp";
                        ...
                        <Col xxl={12} xl={12} lg={12} md={12} ms={12} xs={12}>
                            <div className="inner">
                                <div className="contant">
                                    ...
                                    <h1 className="heading">The Importance of Lifelong Learning: 8 Reasons Why Learning is Important</h1>
                                    <p className="heading_description">Page Last Updated: June 2021</p>
                                </div>
                            </div>
                        </Col>
                    </Row>
